<?php
/* File Name:           new_auction_listing.php
 * Description:         This file contains the script to create a new auction listing
...
if (VerifySession($database))	// if session token is valid for this user, echo true
{
	if ($_POST['category'] != '' && $_POST['time-units'] != '')
	{
		...
		NewListing($database, $_COOKIE['email'], $_POST['name'], 'auction', $_POST['category'], -1, $_POST['reserve_price'], $_POST['duration']);
